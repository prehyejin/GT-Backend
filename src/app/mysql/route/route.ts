...
const deviceController = require('../controller/deviceController.ts');
const groupController = require('../controller/groupController.ts');
const topicController = require('../controller/topicController.ts');
const metricController = require('../controller/metricController.ts');
const visualController = require('../controller/visualController.ts');
