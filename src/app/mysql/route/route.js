...
router.get("/waterGraphHour", visualController.waterGraphHour);
router.get("/waterGraphDay", visualController.waterGraphDay);
router.get("/waterGraphMonth", visualController.waterGraphMonth);
